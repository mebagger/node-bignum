...
#define REQ_INT64_ARG(I, VAR)                                 \
  ...
  int64_t VAR = info[I]->ToInteger(Nan::GetCurrentContext()).ToLocalChecked()->Value();
...
#define REQ_UINT64_ARG(I, VAR)                                \
  ...
  uint64_t VAR = info[I]->IntegerValue(Nan::GetCurrentContext()).ToChecked(); 
...
#define REQ_BOOL_ARG(I, VAR)                                  \
  ...
  bool VAR = info[I]->ToBoolean(Nan::GetCurrentContext()).ToLocalChecked()->Value();
...
NAN_METHOD(BigNum::New)
{
  ...
  if (info[0]->IsExternal()) {
    ...
    Nan::Utf8String str(obj->ToObject(Nan::GetCurrentContext()).FromMaybe(v8::Local<v8::Object>())->Get(Nan::New("num").ToLocalChecked())->ToString(Nan::GetCurrentContext()).FromMaybe(v8::Local<v8::String>()));
    //Nan::Utf8String str(obj->ToObject()->Get(Nan::New("num").ToLocalChecked())->ToString());
    base = Nan::To<int64_t>(obj->ToObject(Nan::GetCurrentContext()).FromMaybe(v8::Local<v8::Object>())->Get(Nan::New("base").ToLocalChecked())).FromJust();
...
NAN_METHOD(BigNum::Badd)
{
  ...
  BigNum *bn = Nan::ObjectWrap::Unwrap<BigNum>(info[0]->ToObject(Nan::GetCurrentContext()).FromMaybe(v8::Local<v8::Object>()));
...
NAN_METHOD(BigNum::Bdiv)
{
  ...
  BigNum *bi = Nan::ObjectWrap::Unwrap<BigNum>(info[0]->ToObject(Nan::GetCurrentContext()).FromMaybe(v8::Local<v8::Object>()));
...
NAN_METHOD(BigNum::Bpowm)
{
  ...
  BigNum *bn1 = Nan::ObjectWrap::Unwrap<BigNum>(info[0]->ToObject(Nan::GetCurrentContext()).FromMaybe(v8::Local<v8::Object>()));
  BigNum *bn2 = Nan::ObjectWrap::Unwrap<BigNum>(info[1]->ToObject(Nan::GetCurrentContext()).FromMaybe(v8::Local<v8::Object>()));
...
NAN_METHOD(BigNum::Bjacobi)
{
  ...
  BigNum *bn_n = Nan::ObjectWrap::Unwrap<BigNum>(info[0]->ToObject(Nan::GetCurrentContext()).FromMaybe(v8::Local<v8::Object>()));
